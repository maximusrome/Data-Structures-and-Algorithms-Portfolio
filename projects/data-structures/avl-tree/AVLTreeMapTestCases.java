...
public class AVLTreeMapTestCases {
    ...
    private Method getTraversal(AVLTreeMap map, String traversal) throws
            NoSuchMethodException {
        Method method = map.getClass().getSuperclass().getDeclaredMethod(traversal,
                Node.class, StringBuilder.class, int.class);
        method.setAccessible(true);
        return method;
    }
    private Method getIterativeSearchMethod(AVLTreeMap map) throws
            NoSuchMethodException {
        Method method =
                map.getClass().getSuperclass().getDeclaredMethod("iterativeSearch",
                        Comparable.class);
        method.setAccessible(true);
        return method;
    }
    @Test
    public void testPut01() throws NoSuchMethodException,
        ...
        assertEquals(null, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 10)).parent);
        retVal = map.put(2, 2);
        assertEquals(null, retVal);
        assertEquals(10, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 2)).parent.key);
        retVal = map.put(2, 3);
        ...
        assertEquals(null, retVal);
        assertEquals(null, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 5)).parent);
        retVal = map.put(12, 13);
        assertEquals(null, retVal);
        assertEquals(10, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 12)).parent.key);
    ...
    @Test
    public void testRemove01() throws NoSuchMethodException,
            InvocationTargetException, IllegalAccessException {
        Pair<Integer, Integer>[] pairs = new Pair[0];
        pairs = new Pair[10];
        for (int i = 0; i < 10; i++) {
        ...
        assertEquals(false, map.isEmpty());
        assertEquals(5, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 1)).parent.key);
        retVal = map.remove(0);
        ...
        assertEquals(false, map.isEmpty());
        assertEquals(2, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 1)).parent.key);
        retVal = map.remove(5);
        assertEquals(6, retVal);
        assertEquals("[<6, 7>, <2, 3>, <1, 2>, <3, 4>, <8, 9>, <7, 8>, <9, 10>]",
                map.preorder());
        assertEquals("[<1, 2>, <2, 3>, <3, 4>, <6, 7>, <7, 8>, <8, 9>, <9, 10>]",
                map.inorder());
        assertEquals(7, map.size());
        assertEquals(false, map.isEmpty());
        assertEquals(8, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 7)).parent.key);
        retVal = map.remove(7);
        assertEquals(8, retVal);
        assertEquals("[<6, 7>, <2, 3>, <1, 2>, <3, 4>, <8, 9>, <9, 10>]",
                map.preorder());
        assertEquals("[<1, 2>, <2, 3>, <3, 4>, <6, 7>, <8, 9>, <9, 10>]",
                map.inorder());
        assertEquals(6, map.size());
        assertEquals(false, map.isEmpty());
        assertEquals(6, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 8)).parent.key);
        retVal = map.remove(8);
        ...
        assertEquals(false, map.isEmpty());
        assertEquals(6, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 9)).parent.key);
        retVal = map.remove(9);
        ...
        assertEquals(false, map.isEmpty());
        assertEquals(6, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 3)).parent.key);
        retVal = map.remove(1);
        assertEquals(2, retVal);
        ...
        assertEquals(false, map.isEmpty());
        assertEquals(null, ((Node<Integer,
                Integer>)getIterativeSearchMethod(map).invoke(map, 2)).parent);
        retVal = map.remove(2);
