...
public class BSTMap<K extends Comparable<K>, V> implements MyMap<K, V> {
    ...
    public static void main(String[] args) {
        ...
        bst.root.left = new Node(7,0);
        bst.root.left.left = new Node(4,0);
        bst.root.left.left.right = new Node(9,0);
        bst.root.left.right = new Node(3,0);
        bst.root.right = new Node(2,0);
        bst.root.right.left = new Node(5,0);
        bst.root.right.right = new Node(8,0);
        bst.root.right.right.left = new Node(6,0);
        bst.root.right.right.right = new Node(0,0);


//        bst = new BSTMap<Integer, Integer>(pairs);
//        bst.root = new Node(1, 0);
//        bst.root.left = new Node(2,0);
//        bst.root.right = new Node(3,0);
//        bst.root.left.left = new Node(4,0);
//        bst.root.left.right = new Node(5,0);
//        bst = new BSTMap<Integer, Integer>(pairs);
//        bst.put(10, 0);
//        bst.put(2, 0);
//        bst.put(1, 0);
