...
public class InversionCounter {
    ...
    /**
     * Returns the number of inversions in an array of integers
     * from the mergesortHelper function.
     * @param array the array to process
     * @return the number of inversions in an array of integers
     */
    public static long mergesort(int[] array) {
        int[] scratch = new int[array.length];
        return mergesortHelper(array, scratch, 0, array.length - 1, 0);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length > 1) {
                ...
                int[] a = readArrayFromStdin();
                if (a.length == 0 || a.equals(" ")) {
                    System.err.print("Error: Sequence of integers not received.");
                    System.exit(1);
                } else {
                    System.out.print("Number of inversions: " + countInversionsFast(a));
                }
                ...
                if (a.length == 0 || a.equals(" ")) {
                    ...
                    System.out.print("Number of inversions: " + countInversionsSlow(a));
                }
            } else {
